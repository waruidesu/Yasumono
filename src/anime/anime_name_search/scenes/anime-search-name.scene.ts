...
import {Anime_Scene, Anime_Search_Name_Scene, startFindAnimeScene} from "../../constants/anime.constants"
...
export class AnimeSearchNameScene {
    constructor(@InjectBot() private readonly bot: Telegraf<Context>, private readonly animeService: AnimeSearchNameService) {}
    @SceneEnter()
    onSceneEnter() {
        console.log("the user has entered the scene(anime search name)")
        return startFindAnimeScene;
    }
